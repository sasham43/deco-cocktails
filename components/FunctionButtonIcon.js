...
import {Svg, Mask, Path, G, Defs, Rectangle, Use} from 'react-native-svg'


export default function FunctionButtonMask(props){
    return (
        <View>
            <Svg width="100" height="75" fill={"#fff"} viewBox="0 0 60000 60000">
                <Defs>
                    <Mask
                        id="Mask"
